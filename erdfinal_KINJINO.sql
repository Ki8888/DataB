...
insert into IMG (IMG_ID, M_B_ID, CONTENTS)
values ('IP01','poster.png');
insert into IMG (IMG_ID, M_B_ID, CONTENTS)
values ('IP02','poseter02.png');
insert into IMG (IMG_ID, M_B_ID, CONTENTS)
values ('IP03','poster03.png');
insert into IMG (IMG_ID, M_B_ID, CONTENTS)
values ('IA01','actor.png');
insert into IMG (IMG_ID, M_B_ID, CONTENTS)
values ('IA02','actor02.png');
insert into IMG (IMG_ID, M_B_ID, CONTENTS)
values ('IA03','actor03.png');
